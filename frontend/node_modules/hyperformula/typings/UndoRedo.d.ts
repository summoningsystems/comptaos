...
export declare class AddSheetUndoEntry extends BaseUndoEntry {
    ...
    readonly sheetId: number;
    constructor(sheetName: string, sheetId: number);
    doUndo(undoRedo: UndoRedo): void;
    doRedo(undoRedo: UndoRedo): void;
}
export declare class RemoveSheetUndoEntry extends BaseUndoEntry {
    ...
    constructor(sheetName: string, sheetId: number, oldSheetContent: ClipboardCell[][], scopedNamedExpressions: [InternalNamedExpression, ClipboardCell][]);
    doUndo(undoRedo: UndoRedo): void;
    doRedo(undoRedo: UndoRedo): void;
}
/**
...
export declare class RenameSheetUndoEntry extends BaseUndoEntry {
    ...
    readonly mergedPlaceholderSheetId?: number | undefined;
    constructor(sheetId: number, oldName: string, newName: string, version?: number | undefined, mergedPlaceholderSheetId?: number | undefined);
    doUndo(undoRedo: UndoRedo): void;
    doRedo(undoRedo: UndoRedo): void;
    getReferencedOldDataVersions(): number[];
}
