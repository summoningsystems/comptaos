 ...
 */
export class SequencePlugin extends FunctionPlugin {
  ...
  sequenceArraySize(ast, _state) {
    ...
    const cols = colsArg === undefined || colsArg.type === AstNodeType.EMPTY ? 1 : SequencePlugin.parseLiteralDimension(colsArg);
    if (cols === undefined) {
      return ArraySize.error();
    }
