...
class UndoRedo {
   ...
   * in-progress batch.
   */
  cleanupOldDataForEntries(discardedEntries, retainedEntries) {
  ...
  collectReferencedOldDataVersions(...entryLists) {
    var _a, _b;
    return new Set([...entryLists.flatMap(list => list.flatMap(e => e.getReferencedOldDataVersions())), ...((_b = (_a = this.batchUndoEntry) === null || _a === void 0 ? void 0 : _a.getReferencedOldDataVersions()) !== null && _b !== void 0 ? _b : [])]);
  }
  undoEntry(operation) {
