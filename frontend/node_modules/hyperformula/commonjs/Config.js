...
class Config {
  constructor(options = {}, showDeprecatedWarns = true) {
    ...
    this.maxPendingLazyTransformations = (0, _ArgumentSanitization.configValueFromParam)(maxPendingLazyTransformations, 'number', 'maxPendingLazyTransformations');
    ...
    (0, _ArgumentSanitization.validateNumberToBeAtLeast)(this.maxPendingLazyTransformations, 'maxPendingLazyTransformations', 1);
