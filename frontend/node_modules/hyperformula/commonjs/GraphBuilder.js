        ...
        for (let j = 0; j < row.length; ++j) {
          ...
          if (parsedCellContent instanceof _CellContentParser.CellContent.Formula) {
            ...
            if (parseResult.errors.length > 0) {
              ...
              if (size.isScalar()) {
                const vertex = new _DependencyGraph.ScalarFormulaVertex(parseResult.ast, address, 0);
                ...
                const vertex = new _DependencyGraph.ArrayFormulaVertex(parseResult.ast, address, new _ArraySize.ArraySize(size.width, size.height));
                dependencies.set(vertex, (0, _absolutizeDependencies.absolutizeDependencies)(parseResult.dependencies, address));
