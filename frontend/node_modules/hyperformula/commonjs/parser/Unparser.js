...
class Unparser {
  constructor(config, sheetMapping, namedExpressions) {
    this.config = config;
  ...
  unparseSheetName(sheetId) {
    const sheetName = (0, _addressRepresentationConverters.sheetIndexToString)(sheetId, id => this.sheetMapping.getSheetNameOrThrowError(id, {
