...
class Interpreter {
  ...
  isSheetValid(address) {
    return address.sheet === undefined || address.sheet === _NamedExpressions.NamedExpressions.SHEET_FOR_WORKBOOK_EXPRESSIONS || this.dependencyGraph.sheetMapping.hasSheetWithId(address.sheet, {
