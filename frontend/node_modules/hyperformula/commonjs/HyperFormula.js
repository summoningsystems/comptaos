...
class HyperFormula {
  ...
  simpleCellAddressFromString(cellAddress, contextSheetId) {
    ...
    return (0, _parser2.simpleCellAddressFromString)(this.sheetMapping.getSheetId.bind(this.sheetMapping), cellAddress, contextSheetId);
  }
  /**
  ...
  simpleCellRangeFromString(cellRange, contextSheetId) {
    ...
    (0, _ArgumentSanitization.validateArgToType)(contextSheetId, 'number', 'sheetId');
    return (0, _parser2.simpleCellRangeFromString)(this.sheetMapping.getSheetId.bind(this.sheetMapping), cellRange, contextSheetId);
  }
  /**
  ...
  simpleCellAddressToString(cellAddress, optionsOrContextSheetId = {}) {
    ...
    return (0, _parser2.simpleCellAddressToString)(this.sheetMapping.getSheetNameOrThrowError.bind(this.sheetMapping), cellAddress, contextSheetId);
  }
  /**
  ...
  simpleCellRangeToString(cellRange, optionsOrContextSheetId = {}) {
    ...
    return (0, _parser2.simpleCellRangeToString)(this.sheetMapping.getSheetNameOrThrowError.bind(this.sheetMapping), cellRange, contextSheetId);
  }
  /**
   ...
   */
  compactLazyTransformationsIfNeeded() {
    var _a;
    if (this._lazilyTransformingAstService.needsCompaction()) {
      ...
      (_a = this._lazilyTransformingAstService.undoRedo) === null || _a === void 0 ? void 0 : _a.cleanupOrphanedOldData();
    }
  }
  /**
...
HyperFormula.version = "3.3.0";
/**
 * Latest build date.
 *
 * @category Static Properties
 */
HyperFormula.buildDate = "20/05/2026 14:43:59";
/**
 * A release date.
 *
 * @category Static Properties
 */
HyperFormula.releaseDate = "20/05/2026";
/**
