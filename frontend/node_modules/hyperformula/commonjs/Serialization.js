...
class Serialization {
  ...
  getCellHyperlink(address) {
    ...
    if (formulaVertex instanceof _DependencyGraph.ScalarFormulaVertex) {
  ...
  getCellFormula(address, targetAddress) {
    ...
    } else if (formulaVertex instanceof _DependencyGraph.ArrayFormulaVertex) {
  ...
  withNewConfig(newConfig, namedExpressions) {
    const newUnparser = new _parser.Unparser(newConfig, this.dependencyGraph.sheetMapping, namedExpressions);
