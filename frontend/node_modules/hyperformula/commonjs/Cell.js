...
const getCellType = (vertex, address) => {
  if (vertex instanceof _DependencyGraph.ArrayFormulaVertex) {
  ...
  if (vertex instanceof _DependencyGraph.ScalarFormulaVertex || vertex instanceof _DependencyGraph.ParsingErrorVertex) {
...
exports.isColOrRowInvalid = isColOrRowInvalid;
